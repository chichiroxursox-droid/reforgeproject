...
const WhoWeAre = () => {
  const statistics = [{
    number: "400+",
    label: "People killed by gunfire in Philadelphia in 2023"
  }, {
    number: "80%",
    label: "Of homicides in the city involved a gun"
  }, {
    number: "#1",
    label: "Gun violence is the leading cause of death for teens in the U.S."
  }, {
    number: "1,700+",
    label: "Shooting incidents reported in Philadelphia in 2024"
  }];
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        backgroundImage: `url(${phillyHero})`
      }}>
